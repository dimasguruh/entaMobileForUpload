...
class RequestState with ChangeNotifier {
  ...
  void updateOvertimeRequestFor({GeneralModel type}) {
    if (type.id == 1) {
  ...
  void updateOvertimeRequestEmployee(
      {List<OvertimeEmployeeRequestModel> employee}) {
    overTimeRequest.employeeList.clear();
  ...
  void updateOvertimeRequestSchedule({DateTimeRange schedule}) {
  ...
  void updateLeaveRequestFor({GeneralModel type}) {
    if (type.id == 1) {
  ...
  void updateLeaveRequestDuration({GeneralModel durationType}) {
  ...
  void updateLeaveRequestEmployee({List<LeaveEmployeeRequestModel> employee}) {
    leaveRequest.employeeList.clear();
  ...
  void updateLeaveRequestSchedule({DateTimeRange schedule}) {
